! function(e) {
    ...
    function i(e) {
        ...
        jQuery(e).each(function() {
            ...
            if (a != e) {
                for (s = 0; s < o.length; s++) o[s].height(i);
                o.length = 0, a = e, i = t.height(), o.push(t)
            } else o.push(t), i = i < t.height() ? t.height() : i;
            for (s = 0; s < o.length; s++) o[s].height(i)
        })
    }
    jQuery(window).on("scroll", function() {
        jQuery(window).scrollTop() > 900 ? jQuery("#whts").fadeIn(1e3) : jQuery("whts").fadeOut(1e3)
        ...
        jQuery('a[href="#search"]').on("click", function(e) {
        ...
        }), jQuery('[data-toggle="tooltip"]').tooltip(), jQuery(".contact-slide-show").on("click", function() {
        ...
        }), jQuery(".sub-menu").parent("li").addClass("has-child"), jQuery(".mega-menu").parent("li").addClass("has-child"), jQuery("<div class='glyphicon glyphicon-plus submenu-toogle'></div>").insertAfter(".has-child > a"), jQuery(".has-child a+.submenu-toogle").on("click", function(e) {
        ...
        }), i = jQuery(".owl-carousel-filter2").owlCarousel({
            loop: !0,
            margin: 30,
            autoplay: !1,
            center: !1,
            ...
            jQuery(this).hasClass("btn-active") || (jQuery(this).addClass("btn-active").siblings().removeClass("btn-active"), i.owlFilter(t, function(e) {
                jQuery(e).find(".item").each(owlAnimateFilter)
            }))
        ...
        return jQuery.ajax({
            ...
            success: function(e) {
                jQuery(".loading-area").hide(), e.success ? (jQuery("<div class='alert alert-success'>" + e.message + "</div>").insertBefore("form.cons-contact-form"), jQuery(".alert-success").delay(2e3).fadeOut(500)) : jQuery("<div class='alert alert-danger'>" + e.message + "</div>").insertBefore("form.cons-contact-form")
            }
        }), !1
    })
}(window.jQuery);